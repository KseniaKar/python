...
async def test_create_book(db_session, async_client):
    seller = Seller(first_name="Alice", last_name="Smith", e_mail="alice@example.com", password="123456")
...
async def test_create_book_with_old_year(db_session, async_client):
    seller = Seller(first_name="Test", last_name="Seller", e_mail="test@example.com", password="pass")
    db_session.add(seller)
    await db_session.flush()
...
async def test_get_books(db_session, async_client):
    seller = Seller(first_name="Test", last_name="Seller", e_mail="seller1@example.com", password="123")
    db_session.add(seller)
    await db_session.flush()
...
async def test_get_single_book(db_session, async_client):
    seller = Seller(first_name="Test", last_name="Seller", e_mail="seller2@example.com", password="123")
    db_session.add(seller)
    await db_session.flush()
...
async def test_update_book(db_session, async_client):
    seller = Seller(first_name="Test", last_name="Seller", e_mail="seller3@example.com", password="123")
    db_session.add(seller)
    await db_session.flush()
...
async def test_delete_book(db_session, async_client):
    seller = Seller(first_name="Test", last_name="Seller", e_mail="seller4@example.com", password="123")
    db_session.add(seller)
    await db_session.flush()
...
async def test_delete_book_with_invalid_book_id(db_session, async_client):
    seller = Seller(first_name="Test", last_name="Seller", e_mail="seller5@example.com", password="123")
    db_session.add(seller)
    await db_session.flush()
